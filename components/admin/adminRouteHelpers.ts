...
export function createManualAnime(): Anime {
  ...
  return {
    ...
    synopsis: "Admin-created catalog entry. Add source metadata before publishing.",
    shortSynopsis: "Admin-created catalog entry.",
...
export function createManualEpisode(
  ...
  return {
    ...
    synopsis: "Admin-created episode entry.",
    youtubeVideoId: "",
